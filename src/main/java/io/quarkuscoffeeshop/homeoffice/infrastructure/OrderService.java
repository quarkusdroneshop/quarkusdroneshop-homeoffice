...
public class OrderService {
    ...
    static final Map<StoreLocation, List<String>> baristas = new HashMap() {{
        put(
    ...
    static final Map<StoreLocation, List<String>> cooks = new HashMap() {{
        put(
                StoreLocation.ATLANTA,
                Arrays.asList(
                        "Hortelano H",
    ...
    private final String randomBarista(final StoreLocation storeLocation) {
        return randomName(baristas.get(storeLocation));
    }

    private final String randomCook(final StoreLocation storeLocation) {
